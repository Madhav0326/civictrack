...
import { Loader2, Mail, Lock, User, ArrowLeft, Eye, EyeOff, Check, X, HelpCircle } from 'lucide-react';
      ...
      <Card className="w-full">
        ...
        <CardContent>
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            {/* 1. Password Field with Info Popover & Progress Bar */}
            <div className="space-y-1.5">
              ...
              {/* Strength/Progress Bar directly below Password Field */}
              {password.length > 0 && (
